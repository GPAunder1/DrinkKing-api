...
describe 'Unit test of Result value' do
  it 'should valid success status and message' do
    result = DrinkKing::Response::ApiResult.new(status: :ok, message: 'foo')
  ...
  it 'should valid failure status and message' do
    result = DrinkKing::Response::ApiResult.new(status: :not_found, message: 'foo')
  ...
  it 'should report error for invalid status' do
    _(proc do
      DrinkKing::Response::ApiResult.new(status: :foobar, message: 'foo')
